...
class ApplicationDtoMapperTest {
    ...
    void toResponseDto_shouldMapApplicationToApplicationResponseDto() {
        ...
        assertNotNull(dto);
        assertAll(
                () -> assertEquals(application.getApplicationId(), dto.applicationId()),
                ...
                () -> assertEquals(application.getIdentityDocument(), dto.identityDocument()),
                () -> assertEquals(application.getStatusId(), dto.statusId()),
    ...
    void toBuilder_shouldMapCreateApplicationDtoToApplicationBuilder() {
        CreateApplicationDto createDto = new CreateApplicationDto(
                new BigDecimal("1500.00"), "24 months", "create@example.com", 987654321L, 3L
        );
        ...
        assertAll(
                () -> assertEquals(createDto.amount(), builtApplication.getAmount()),
                () -> assertEquals(createDto.term(), builtApplication.getTerm()),
                () -> assertEquals(createDto.email(), builtApplication.getEmail()),
                () -> assertEquals(createDto.identityDocument(), builtApplication.getIdentityDocument()),
    ...
    void toModel_shouldMapCreateApplicationDtoToApplicationBuilder() {
        CreateApplicationDto createDto = new CreateApplicationDto(
                new BigDecimal("2000.00"), "36 months", "model@example.com", 1122334455L, 4L
        );
